...
//                phase = 3;
        ...
        if (phase === 1) {
            ...
            if(lastThroughput * 0.85> throughput) {
                console.log("1");
                q = maxBitrateIndex(bitrates, throughput * 0.8);
            }

            else if (boc < ALPHA + (BETA - ALPHA) * 0.3) {
                // q = bitrateNearest(bitrates, throughput);
                if (throughput * 0.7 < bitrates[q]) {
                    q -= 1;
                }
                //                console.log("[NEAR] " + throughput + "-->" + bitrates[q]);
            } else if (boc >= ALPHA + (BETA - ALPHA) * 0.8) {
        ...
        // msg += "throughput*0.8 = " + (throughput * 0.8) + "\n";
        // msg += "latency = " + (latency) + "\n";
        // msg += "quality = " + q + "(" + bitrates[q] + ")" + "\n";
