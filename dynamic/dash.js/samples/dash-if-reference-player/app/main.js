...
app.controller('DashController', function ($scope, sources, contributors, dashifTestVectors) {
    $scope.selectedItem = {
//        url: 'http://166.104.231.227/source/test/test.mpd'
//        url: 'http://166.104.231.227/source/lab/lab.mpd'
        url: 'https://ms.hanyang.ac.kr/video-source/lab/source_dash.mpd'
    };
    ...
    $scope.scheduleWhilePausedSelected = false;
    ...
    $scope.toggleUseCustomABRRules = function () {
        ...
        if ($scope.customABRRulesSelected) {
            ...
            $scope.player.addABRCustomRule('qualitySwitchRules', 'MyRule', MyRule); /* jshint ignore:line */
            ...
            $scope.player.removeABRCustomRule('MyRule');
        }
    };
...
//    $scope.player.setBufferAheadToKeep(60);
...
function printLog() {
    ...
    throughputHistory.push(throughputHistory[throughputHistory.length - 1]);
    bitrateHistory.push(bitrateHistory[bitrateHistory.length - 1]);
    bufferHistory.push(0);

    let msg;
    msg = "";
    msg += "dynamic_bo_x = [" + timeHistory.toString() + "]" + "\n";
    msg += "dynamic_bo_y = [" + bufferHistory.toString() + "]" + "\n"

    msg += "dynamic_th_x = [" + timeHistory.toString() + "]" + "\n";
    msg += "dynamic_th_y = [" + throughputHistory.toString() + "]" + "\n"

    msg += "dynamic_br_x = [" + timeHistory.toString() + "]" + "\n";
    msg += "dynamic_br_y = [" + bitrateHistory.toString() + "]" + "\n"

    msg += "dynamic_lt_x = [" + timeHistory.toString() + "]" + "\n";
    msg += "dynamic_lt_y = [" + latencyHistory.toString() + "]" + "\n";

    msg += "draw_plot(dynamic_bo_x, dynamic_bo_y, dynamic_th_x, dynamic_th_y, dynamic_br_x, dynamic_br_y)" + "\n";

    msg += "print(\"average br = \", calc_avg_bitrate(dynamic_br_x, dynamic_br_y))" + "\n";
    msg += "print(\"average tp = \", np.average(dynamic_th_y))" + "\n";
    msg += "print(\"average lt = \", np.average(dynamic_lt_y))" + "\n";
    msg += "print(\"rebuffering = \", QoeUtil(dynamic_br_x, dynamic_br_y, dynamic_bo_x, dynamic_bo_y).calc_rebuffer())" + "\n";

    // if(isMulti) {
    //     msg = "";
    //     msg += "dynamic_bo_x = [" + bufferHistory_x.toString() + "]" + "\n";
    //     msg += "dynamic_bo_y = [" + bufferHistory.toString() + "]" + "\n"
    //
    //     msg += "dynamic_th_x = [" + timeHistory.toString() + "]" + "\n";
    //     msg += "dynamic_th_y = [" + throughputHistory.toString() + "]" + "\n"
