...
function RealBBARuleClass() {
    ...
    // function checkRatio(newIdx, currentBandwidth, data) {
    //     var self = this,
    //         deferred = Q.defer();
    //
...
//        console.log(msg);
        ...
        return SwitchRequest(context).create(q, {name : RealBBARuleClass.__dashjs_factory_name},  p);
    }
...
RealBBARuleClass.__dashjs_factory_name = 'RealBBARule';
RealBBARule = dashjs.FactoryMaker.getClassFactory(RealBBARuleClass);
