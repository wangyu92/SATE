...
function printLog() {
    ...
    let msg;
    msg = "";
    msg += "sate_bo_x = [" + timeHistory.toString() + "]" + "\n";
    msg += "sate_bo_y = [" + bufferHistory.toString() + "]" + "\n"

    msg += "sate_th_x = [" + timeHistory.toString() + "]" + "\n";
    msg += "sate_th_y = [" + throughputHistory.toString() + "]" + "\n"

    msg += "sate_br_x = [" + timeHistory.toString() + "]" + "\n";
    msg += "sate_br_y = [" + bitrateHistory.toString() + "]" + "\n"

    msg += "sate_lt_x = [" + timeHistory.toString() + "]" + "\n";
    msg += "sate_lt_y = [" + latencyHistory.toString() + "]" + "\n";

    msg += "draw_plot(sate_bo_x, sate_bo_y, sate_th_x, sate_th_y, sate_br_x, sate_br_y)" + "\n";

    msg += "print(\"average br = \", calc_avg_bitrate(sate_br_x, sate_br_y))" + "\n";
    msg += "print(\"average tp = \", np.average(sate_th_y))" + "\n";
    msg += "print(\"average lt = \", np.average(sate_lt_y))" + "\n";
    msg += "print(\"rebuffering = \", QoeUtil(sate_br_x, sate_br_y, sate_bo_x, sate_bo_y).calc_rebuffer())" + "\n";
